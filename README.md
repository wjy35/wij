...
![Static Badge](https://img.shields.io/badge/WangJun%20Intellij%20Judge-v1.0.4-good?style=plastic&color=%236699CC)
</a>
...
| Run                    | Description                      |
|:-----------------------|:---------------------------------|
| Judge                  | 가장 최근 Fetch 된 I/O 로 테스트를 시작합니다. |
| Fetch I/O File & Judge | 새롭게 I/O를 Fetch 하고 테스트를 시작합니다.   |
| Delete All             | Input과 Output 파일을 모두 삭제합니다.      |
| Go to I/O Directory    | io Directory 를 엽니다.              |
| Open First File        | 첫번째 I/O 파일을 엽니다.                 |

##### Fetch I/O File & Judge 를 선택한 경우 문제 번호를 입력해주세요.
...
|:-----------------------|:-----------------------------------|
| Judge                  | Control + Alt + J    |
| Fetch I/O File & Judge | Control + Alt + U |
...
| Fetch I/O File & Judge  | Control + Option + U |
...
##### Fetch
- `Fetch I/O File & Judge` 를 실행한 경우에만 실행 됩니다.
- 문제번호를 입력 받아 Input & Output 을 `wij/io/your_java_package/` 에 저장합니다.
